...
class Pathplanning:
    ...
    def determine_nodes(self):
        ...
        #     num_facil -= 1
        ##-----------------------------------------------------------
        self.facility_coords=[(400, 300), (600, 200), (350, 400)]
        ...
        for c1 in self.facility_coords: # O(n^2)
            for c2 in self.facility_coords:
                if c1 != c2 and ((c2, c1) not in self.routes.keys()):
                    ...
                    route = planning_algo.draw_route(c1, c2, self.img) # self.img is [[pix pix]]
...
if __name__ == '__main__':
    g = Pathplanning('/home/bao/Map_unit/Map_unit/data/Sample_Res_700.png',
    '/home/bao/Map_unit/Map_unit/data/reserves_700.png', [1, 2, 3, 4], ascending_gradient=False)
    g.run()
